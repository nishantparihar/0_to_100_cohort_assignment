...
function signJwt(username, password) {
    ...
    const usernameValidity = usernameSchema.safeParse(username);
    const passwordValidity = passwordSchema.safeParse(password);

    if(usernameValidity.success && passwordValidity.success){
        return jwt.sign({
            username: username,
            password: password,
        }, jwtPassword);
